...
if [ $? -eq 0 ]; then
    ...
    cp $BUILD_DIR/unified/hamclock-next $BUILD_DIR/hamclock-next.unified.${VERSION}.linux-armhf
    ...
    cp $BUILD_DIR/fb0/hamclock-next $BUILD_DIR/hamclock-next.fb0.${VERSION}.linux-armhf
